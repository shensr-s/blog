...
!function (t) {
    ...
    t.languages["robot-framework"] = {
        ...
        comment: r
    }, t.languages.robot = t.languages["robot-framework"]
}(Prism);
!function (e) {
    var n = "(?:\\([^|)]+\\)|\\[[^\\]]+\\]|\\{[^}]+\\})+", i = {
